        ...
        <tbody>
          <#list statusInfo.generalStats?keys as stat>
            <tr>
                <td>
                    <#switch stat>
                        <#case "total-avail-memory">总可用内存<#break>
                        <#case "environment">环境<#break>
                        <#case "num-of-cpus">CPU数<#break>
                        <#case "current-memory-usage">已使用内存<#break>
                        <#case "server-uptime">正常运行时间<#break>
                        <#default>${stat}
                    </#switch>
                </td>
          ...
          <#list statusInfo.applicationStats?keys as stat>
            <tr>
                <td>
                    <#switch stat>
                        <#case "registered-replicas">已注册副本<#break>
                        <#case "unavailable-replicas">不可用副本<#break>
                        <#case "available-replicas">可用副本<#break>
                        <#default>${stat}
                    </#switch>
                </td>
    ...
    <table id='instanceInfo' class="table table-striped table-hover">
        ...
        <tbody>
          ...
          <tr>
              <td>
                  <#switch key>
                      <#case "ipAddr">IP地址<#break>
                      <#case "status">状态<#break>
                      <#default>${key}
                  </#switch>
              </td>
