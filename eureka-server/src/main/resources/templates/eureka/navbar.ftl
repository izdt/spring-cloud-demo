...
<#if isBelowRenewThresold>
    <#if !registry.selfPreservationModeEnabled>
        <h4 id="uptime"><font size="+1" color="red"><b style="display:none">续约低于阀值. 自我保护模式关闭. 对于网络/其他问题，这可能无法保护实例过期.</b></font></h4>
    <#else>
...
<#elseif !registry.selfPreservationModeEnabled>
    <h4 id="uptime"><font size="+1" color="red"><b style="display:none">自我保护模式关闭.对于网络/其他问题，这可能无法保护实例过期.</b></font></h4>
</#if>
